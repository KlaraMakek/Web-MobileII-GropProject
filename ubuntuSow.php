...
<div id="top" class="container">
    <h1>Installation</h1>
    <h2>Ubuntu software center</h2>
    <p>When doing this make sure you use an empty stick, as all the data will erase!</p>
    <ul>
        <li>If you prefer a graphical user interface, Linux has advanced significantly. The Ubuntu software center is an
            excellent choice for installing and managing software packages.</li>
        <li>Below is a typical screenshot of the Ubuntu software center's GUI. The top bar contains four main buttons:
            ...
            <img src="assets\img\UbuntuSoftwareCenter.png" alt="Ubuntu software center.">
